...
const courseImage = "https://lh3.googleusercontent.com/aida-public/AB6AXuAmAQHpMuBwCcDsDpTLkCnsQnJsX9y1GqCjV4jvCmElP-NP3vpT40Zk5iIyWP_z1PHVoNJlPhI5nGAyRRKZzP_pHy-WU4JIkzdSriYAwxOCeRUP_N3OQSKG_RUvKaDuXqvADvRwFC1k3d01Xpv7a1rCXTdPwzTJzPfUuqDV3wOjAObH8d5W8qbG6MvxpNXCpCfyQ9Nxkzu5s7pPi0p9lwH9S6X_vBZlTJQUClBeCmPcIMA_mbql86k-5Q_7cnUNMZ9UYyCiAkm0DFA";
          ...
          <section className="lg:col-span-7">
            <div className="bg-surface-container rounded-xl p-8 lg:p-12 shadow-[0_0_24px_rgba(232,80,10,0.05)] border-t border-outline-variant/10">
              ...
              <form className="space-y-6">
                ...
                <div className="pt-6">
                  <button
                    className="w-full bg-gradient-to-r from-primary to-primary-container text-on-primary-container font-black text-lg py-5 rounded-xl shadow-[0_4px_24px_rgba(250,92,27,0.3)] hover:scale-[1.02] active:scale-95 transition-all duration-300 flex items-center justify-center gap-3"
                    type="submit"
                  >
              ...
              <div className="mt-8 flex items-center justify-center gap-2 text-slate-500">
                ...
                <p className="text-[11px]">
                  Your payment is processed through a secure 256-bit encrypted gateway
                </p>
              </div>
            </div>
          </section>
